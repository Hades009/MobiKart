...
<body style="background-image: url('bgforgot.jpg'); background-repeat:no-repeat">
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Label ID="Npass" runat="server">New Password</asp:Label><asp:TextBox ID="txtPass" runat="server" CssClass="form-control" Textmode="Password" required="required"></asp:TextBox>
        </div>
        <div>
